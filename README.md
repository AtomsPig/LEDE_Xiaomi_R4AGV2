...
如果您在使用过程中发现问题需要反馈请提 issues （由于我的能力十分有限，问题可能无法得到解决，但我会尽力尝试）

如有技术问题需要讨论或者交流，欢迎加入以下 LEDE 官方群(与本项目无关)：

1. QQ 讨论群： OP固件技术研究群，号码 891659613 ，加群链接：[点击加入](https://jq.qq.com/?_wv=1027&k=XL8SK5aC "Op固件技术研究群")
2. TG 讨论群： OP编译官方大群，加群链接：[点击加入](https://t.me/JhKgAA6Hx1 "OP 编译官方大群")
...
使用 [Actions-OpenWrt](https://github.com/P3TERX/Actions-OpenWrt) 利用 GitHub Actions 进行云编译
本项目云编译仓库地址<https://github.com/AtomsPig/Action_LEDE_Xiaomi_R4AGV2>
...
如果您觉得此项目对您有帮助，可以捐助我们，以鼓励项目能持续发展，更加完善
...
感谢您使用此项目，如果您喜欢此项目，可以给此项目点个 star ，您的支持就是对我最大的鼓励
